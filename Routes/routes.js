...
import { authorizeRole } from "../Controller/reservationController.js";
...
router.post('/reservations', authenticate, authorizeRole('enseignant', 'administrateur'), reservationController.listReservations);
